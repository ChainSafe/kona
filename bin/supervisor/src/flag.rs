...
pub struct GlobalArgs {
    ...
    #[arg(long = "l2-consensus.nodes", env = "L2_CONSENSUS_NODES", help = "L2 consensus node RPCs", value_delimiter = ',')]
    pub l2_consensus_nodes: Vec<String>,

     /// JWT secrets for L2 consensus nodes.
    #[arg(long = "l2-consensus.jwt-secret", env = "L2_CONSENSUS_JWT_SECRET", help = "JWT secrets for L2 consensus nodes", value_delimiter = ',')]
    ...
    #[arg(long = "datadir.sync-endpoint", env = "DATADIR_SYNC_ENDPOINT", help = "Sync endpoint for supervisor")]
